...
class UserModel with ChangeNotifier implements AuthBase {
  ...
  Future<Users> currentUser() async {
    try {
      ...
      debugPrint("ViewModeldeki (currentuser) current user hata : " + e.toString());
      return null;
    } finally {
  ...
  Future<Users> signInAnonymously() async {
    try {
      ...
      debugPrint("ViewModeldeki (signInAnonymously) user hata : " + e.toString());
      return null;
    } finally {
      state = ViewState.Idle;
    }
  ...
  Future<Users> signInWithGoogle() async {
    try {
      ...
      debugPrint("Viewmodeldeki (signInWithGoogle) current user hata:" + e.toString());
      return null;
    } finally {
      state = ViewState.Idle;
    }
  ...
  Future<Users> signInWithFacebook() async {
    try {
      ...
      debugPrint("ViewModeldeki (signInWithFacebook) current user hata : " + e.toString());
      return null;
    } finally {
      state = ViewState.Idle;
    }
